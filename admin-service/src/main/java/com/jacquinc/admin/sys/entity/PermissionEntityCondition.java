...
public class PermissionEntityCondition extends BaseEntityCondition implements Serializable {
    ...
    public PermissionEntityCondition() {
    ...
    protected abstract static class GeneratedCriteria {
         ...
         *  where name like '%abc%' or name2 like '%abc' or name3 like 'abc%'
         */
        public Criteria andMenuIdLikeIgnoreCase(String value) {
            addCriterion("upper(menu_id) like ", value.toUpperCase(), "menuId");
            return (Criteria) this;
        }
