...
public class MenuEntityCondition extends BaseEntityCondition implements Serializable {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andIsAdminLikeInsensitive(String value) {
            addCriterion("upper(is_admin) like", value.toUpperCase(), "isAdmin");
            return (Criteria) this;
        }

        public Criteria andIsPartnerLikeInsensitive(String value) {
            addCriterion("upper(is_partner) like", value.toUpperCase(), "isPartner");
            return (Criteria) this;
        }
         ...
         *  where name like '%abc%' or name2 like '%abc' or name3 like 'abc%'
         */
        public Criteria andIsAdminLikeIgnoreCase(String value) {
            addCriterion("upper(is_admin) like ", value.toUpperCase(), "isAdmin");
            return (Criteria) this;
        }
         ...
         *  where name like '%abc%' or name2 like '%abc' or name3 like 'abc%'
         */
        public Criteria andIsPartnerLikeIgnoreCase(String value) {
            addCriterion("upper(is_partner) like ", value.toUpperCase(), "isPartner");
            return (Criteria) this;
        }
    }
