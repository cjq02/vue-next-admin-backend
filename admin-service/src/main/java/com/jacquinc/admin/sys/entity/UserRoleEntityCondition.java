...
public class UserRoleEntityCondition extends BaseEntityCondition implements Serializable {
    ...
    public UserRoleEntityCondition() {
    ...
    protected abstract static class GeneratedCriteria {
         ...
         *  where name like '%abc%' or name2 like '%abc' or name3 like 'abc%'
         */
        public Criteria andUserIdLikeIgnoreCase(String value) {
            addCriterion("upper(user_id) like ", value.toUpperCase(), "userId");
            return (Criteria) this;
        }
