...
public class RolePermissionEntityCondition extends BaseEntityCondition implements Serializable {
    ...
    public RolePermissionEntityCondition() {
    ...
    protected abstract static class GeneratedCriteria {
         ...
         *  where name like '%abc%' or name2 like '%abc' or name3 like 'abc%'
         */
        public Criteria andRoleIdLikeIgnoreCase(String value) {
            addCriterion("upper(role_id) like ", value.toUpperCase(), "roleId");
            return (Criteria) this;
        }
         ...
         *  where name like '%abc%' or name2 like '%abc' or name3 like 'abc%'
         */
        public Criteria andPermissionIdLikeIgnoreCase(String value) {
            addCriterion("upper(permission_id) like ", value.toUpperCase(), "permissionId");
            return (Criteria) this;
        }
    }
